    ...
    <section id="exchange-partners" className="relative z-10 py-10">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center gap-8 flex-wrap">
          ...
          {/* CoinCodex */}
          <a href="https://coincodex.com/crypto/memexsol/" target="_blank" rel="noopener noreferrer">
            <img
              src="https://pbs.twimg.com/profile_images/1922619676497944576/Fsiv6gE2_400x400.jpg"
              alt="CoinCodex"
              className="w-32 h-auto"
            />
          </a>
           {/* Kriptomat */}
          <a href="https://kriptomat.io/cryptocurrency-prices/memexsol-price/" target="_blank" rel="noopener noreferrer">
            <img
              src="https://pbs.twimg.com/profile_images/1724063342938005504/uqSC-UD2_400x400.jpg"
              alt="Kriptomat"
              className="w-32 h-auto"
            />
          </a>
          {/* CoinStats */}
          <a href="https://coinstats.app/tr/coins/memexsol/" target="_blank" rel="noopener noreferrer">
            <img
              src="https://pbs.twimg.com/profile_images/1944729554074959872/7f2x1AFs_400x400.jpg"
              alt="CoinStats"
              className="w-32 h-auto"
            />
          </a>
          {/* Pump.fun */}
          <a href="https://swap.pump.fun/?input=So11111111111111111111111111111111111111112&output=AsjP9VyKUSuLSeycoTb9AqGs3PH6BWAvqDoKmxrWpump" target="_blank" rel="noopener noreferrer">
            <img
              src="https://pbs.twimg.com/profile_images/1748108741503803392/EmT4yP6S_400x400.jpg"
              alt="Pump.fun"
              className="w-32 h-auto"
            />
          </a>
          {/* Dexscreener */}
          <a href="https://dexscreener.com/solana/5fxe95ubfy5kbacgr59zbtcczage5wgaaedheblblhr4" target="_blank" rel="noopener noreferrer">
            <img
