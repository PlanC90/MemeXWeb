        ...
        <div className="max-w-3xl mx-auto bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700">
          ...
          <div className="mt-8 border-t border-gray-700 pt-8">
            ...
            <p className="text-gray-400 text-center">
              MemeX was launched on January 4, 2025, and immediately opened to the community. In a short time, a strong supporter base formed the "MemeX ARMY." Fueled by the community’s energy, MemeX continues to grow. Join the movement today!community now!
            </p>
